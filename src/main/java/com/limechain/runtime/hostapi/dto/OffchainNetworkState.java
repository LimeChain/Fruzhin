 ...
 * @param multiAddresses the list of libp2p Multiaddresses the node knows it can be reached at
 */
public record OffchainNetworkState(PeerId peerId, List<Multiaddr> multiAddresses) {
}
