...
import com.limechain.network.protocol.grandpa.messages.commit.CompactJustificationScaleWriter;
...
public class CatchUpMessageScaleWriter implements ScaleWriter<CatchUpMessage> {
    ...
    public void write(ScaleCodecWriter writer, CatchUpMessage catchUpMessage) throws IOException {
        ...
        new CompactJustificationScaleWriter().write(writer, catchUpMessage.getPreVotes());
        new CompactJustificationScaleWriter().write(writer, catchUpMessage.getPreCommits());
