...
import static com.limechain.trie.decoded.Helper.assertLongEncoding;
import static com.limechain.trie.decoded.Helper.assertShortEncoding;
import static com.limechain.trie.decoded.Helper.getBadNodeEncoding;
import static com.limechain.trie.decoded.Helper.leafAShort;
import static com.limechain.trie.decoded.Helper.leafBLarge;
import static com.limechain.trie.decoded.Helper.leafCLarge;
import static com.limechain.trie.decoded.Helper.padRightChildren;
...
class TrieVerifierTest {
    ...
    void buildingProofTrieExceptionTest() {
        ...
        Exception e = assertThrows(IllegalArgumentException.class, () -> {
            TrieVerifier.buildTrie(new byte[][]{}, rootHash);
        });
        assertTrue(e.getMessage().contains("Encoded proof nodes is empty"));
    }
    ...
    void valueNotFoundExceptionTest() {
        ...
        Trie trie = TrieVerifier.buildTrie(encodedNodes, rootHash);

        Exception e = assertThrows(Exception.class, () ->
                TrieVerifier.verify(trie, keyLE, value)
        );
    ...
    void keyFoundWithMismatchValueExceptionTest() {
        ...
        byte[] keyLE = new byte[]{0x34, 0x21};
        Trie trie = TrieVerifier.buildTrie(encodedNodes, rootHash);
        Exception e = assertThrows(IllegalStateException.class, () -> TrieVerifier.verify(trie, keyLE, value));
