...
class MerkleProverTest {

    @Test
    void decodeAndVerifyProof() {
        // Key/value taken from the Polkadot genesis block.
        byte[] proofs = ArrayUtils.toPrimitive(Stream.of(
        ...
        Hash256 trieRoot = Hash256.from("29d0d972cd27cbc511e9589fcb7a4506d5eb6a9e8df205f00472e5ab354a4e17");

        HashMap<Hash256, Integer> decoded = MerkleProver.decodeAndVerifyProof(proofs, trieRoot);
