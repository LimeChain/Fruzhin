...
public class BlockExecutorTest {
    ...
    @BeforeEach
    public void setup() {
        new RpcApp().start(new String[]{});
    }

    @Test
    void kusamaFirstBlock() throws IOException {
        var holder = AccessorHolder.getInstance();
        var accessor = holder.newAccessor();

//        byte[] genesisRoot = StringUtils.hexToBytes("0xb0006203c3a6e6bd2c6a17b1d4ae8ca49a31da0f4579da950b127774b44aef6b");
        ...
        // FileUtils.writeByteArrayToFile(new File("code.wasm"), runtimeByteCode);
        ...
        // Core_execute_block fails with the mystical rust panic
