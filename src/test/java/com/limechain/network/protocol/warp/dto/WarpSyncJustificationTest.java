...
public class WarpSyncJustificationTest {
    ...
    public void verifySignature() {
        byte[] data = new byte[]{1, -13, 36, -82, -83, -110, 86, 43, -28, -50, 90, -22, -96, 49, -67, 120, 7, 18, 63, 20, 82, 56, 100, -100, -30, 64, 67, -126, 60, 78, 32, -74, 26, -86, 117, -17, 0, -11, 46, 4, 0, 0, 0, 0, 0, 14, 25, 0, 0, 0, 0, 0, 0};
        ...
        boolean isValid = justification.verifySignature(publicKey, signatureHex, data);
        assertTrue(isValid);
    }
}
