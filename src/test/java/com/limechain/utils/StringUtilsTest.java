...
class StringUtilsTest {
    ...
    @Test
    public void decodesPrefixedHexString() {
    ...
    @Test
    public void decodesNonPrefixedHexString() {
    ...
    @Test
    public void decodeFailsIfLengthIsOddPrefixed() {
    ...
    @Test
    public void decodeFailsIfLengthIsOddNotPrefixed() {
